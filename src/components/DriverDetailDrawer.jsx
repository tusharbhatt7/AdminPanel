        ...
        <div className="group bg-surface rounded-lg border border-line overflow-hidden flex flex-col transition-all duration-300 hover:shadow-lg hover:border-primary-200 hover:-translate-y-1">
            <div className="px-4 py-3 bg-raised border-b border-line flex justify-between items-center transition-colors group-hover:bg-primary-50/50">
                <h4 className="text-sm font-semibold text-fg flex items-center">
                    <ShieldCheck className="w-4 h-4 mr-2 text-brand-ink transition-transform group-hover:scale-110 duration-300" />
                    {title}
                </h4>
                <select
                    name={statusName}
            ...
            <div className="p-4 bg-raised flex-1 flex flex-col justify-center items-center overflow-hidden">
                {url ? (
                    ...
                    <div className="w-full h-48 rounded-lg border-2 border-dashed border-line flex flex-col items-center justify-center text-fg-3 bg-surface transition-colors duration-300 group-hover:border-primary-300 group-hover:bg-primary-50/30">
                        ...
                        <span className="text-sm font-medium transition-colors duration-300 group-hover:text-brand-ink">No Image Uploaded</span>
                    </div>
                )}
            </div>
                ...
                <div className="flex-1 min-h-0 flex flex-col -mt-4 sm:-mt-8 mx-4 sm:mx-6 bg-surface rounded-t-2xl border border-line overflow-hidden z-10">
                    ...
                    <div className="flex border-b border-line bg-surface/80 backdrop-blur-md sticky top-0 z-20 px-1 sm:px-2 pt-1 sm:pt-2">
                        <button
                            ...
                            className={`flex-1 py-2 sm:py-3 px-2 sm:px-4 text-xs sm:text-sm font-semibold text-center border-b-2 transition-all duration-300 outline-none ${activeTab === 'profile' ? 'border-primary-600 text-brand-ink bg-primary-50/50' : 'border-transparent text-fg-3 hover:text-fg hover:bg-raised'}`}
                        >
                            <User className={`w-3.5 h-3.5 sm:w-4 sm:h-4 inline-block mr-1.5 sm:mr-2 mb-0.5 transition-colors duration-300 ${activeTab === 'profile' ? 'text-brand-ink' : 'text-fg-3'}`} />
                            Profile & Vehicle
                        </button>
                        <button
                            type="button"
                            onClick={() => setActiveTab('documents')}
                            className={`flex-1 py-2 sm:py-3 px-2 sm:px-4 text-xs sm:text-sm font-semibold text-center border-b-2 transition-all duration-300 outline-none ${activeTab === 'documents' ? 'border-primary-600 text-brand-ink bg-primary-50/50' : 'border-transparent text-fg-3 hover:text-fg hover:bg-raised'}`}
                        >
                            <FileText className={`w-3.5 h-3.5 sm:w-4 sm:h-4 inline-block mr-1.5 sm:mr-2 mb-0.5 transition-colors duration-300 ${activeTab === 'documents' ? 'text-brand-ink' : 'text-fg-3'}`} />
                            Verification Docs
                        </button>
                    </div>
                            ...
                            {activeTab === 'profile' && (
                                <div className="space-y-6 sm:space-y-8 transition-all duration-500 ease-in-out origin-top">
                                    ...
                                    <div className="group/section">
                                        <h3 className="text-sm font-bold text-fg uppercase tracking-wider mb-3 sm:mb-4 flex items-center"><User className="w-4 h-4 mr-2 text-brand-ink transition-transform group-hover/section:scale-110 duration-300" /> Personal Details</h3>
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5">
                                            <div className="col-span-1 md:col-span-2 group/input">
                                                <label className="block text-xs font-semibold text-fg-3 mb-1.5 transition-colors group-focus-within/input:text-brand-ink">Full Name</label>
                                            ...
                                            <div className="group/input">
                                                <label className="block text-xs font-semibold text-fg-3 mb-1.5 flex items-center transition-colors group-focus-within/input:text-brand-ink"><Phone className="w-3 h-3 mr-1" /> Phone Number</label>
                                            ...
                                            <div className="group/input">
                                                <label className="block text-xs font-semibold text-fg-3 mb-1.5 flex items-center transition-colors group-focus-within/input:text-brand-ink"><Mail className="w-3 h-3 mr-1" /> Email Address</label>
                                            ...
                                            <div className="group/input">
                                                <label className="block text-xs font-semibold text-fg-3 mb-1.5 flex items-center transition-colors group-focus-within/input:text-brand-ink"><User className="w-3 h-3 mr-1" /> Gender</label>
                                            ...
                                            <div className="group/input">
                                                <label className="block text-xs font-semibold text-fg-3 mb-1.5 flex items-center transition-colors group-focus-within/input:text-brand-ink"><Calendar className="w-3 h-3 mr-1" /> Date of Birth</label>
                                    ...
                                    {/* Operational Details */}
                                    <div className="group/section">
                                        <h3 className="text-sm font-bold text-fg uppercase tracking-wider mb-4 flex items-center"><Activity className="w-4 h-4 mr-2 text-brand-ink transition-transform group-hover/section:scale-110 duration-300" /> Operational Attributes</h3>
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                            <div className="group/input">
                                                <label className="block text-xs font-semibold text-fg-3 mb-1.5 flex items-center transition-colors group-focus-within/input:text-brand-ink"><Car className="w-3 h-3 mr-1" /> Vehicle Type</label>
                                            ...
                                            <div className="group/input">
                                                <label className="block text-xs font-semibold text-fg-3 mb-1.5 flex items-center transition-colors group-focus-within/input:text-brand-ink"><CircleDot className="w-3 h-3 mr-1" /> Service Mode</label>
                                            ...
                                            <div className="group/input">
                                                <label className="block text-xs font-semibold text-fg-3 mb-1.5 flex items-center transition-colors group-focus-within/input:text-brand-ink"><CircleDot className="w-3 h-3 mr-1" /> Operational Status</label>
                                    ...
                                    <div className="bg-raised rounded-lg p-5 border border-line">
                                        <h3 className="text-sm font-bold text-fg uppercase tracking-wider mb-4 flex items-center"><CreditCard className="w-4 h-4 mr-2 text-brand-ink" /> Financial Overview</h3>
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            <div className="bg-surface p-4 rounded-lg shadow-[0_2px_10px_-3px_rgba(0,0,0,0.05)] border border-line/60 transition-all duration-300 hover:-translate-y-0.5 group/card">
                                                <label className="block text-xs font-semibold text-fg-3 uppercase tracking-wider mb-2 transition-colors group-hover/card:text-brand-ink">Wallet Balance</label>
                                                <div className="relative">
                                                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                                        <span className="text-fg-3 font-semibold group-focus-within/card:text-brand-ink transition-colors">₹</span>
                                                    </div>
