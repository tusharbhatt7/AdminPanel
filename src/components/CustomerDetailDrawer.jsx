    ...
    return (
        <div className="fixed inset-0 z-50 overflow-hidden flex justify-end">
            ...
            <div className={`relative w-full max-w-2xl bg-slate-50 shadow-2xl flex flex-col h-full transform transition-transform duration-300 ease-out ${isVisible ? 'translate-x-0' : 'translate-x-full'}`}>
                    ...
                    <div className="flex items-center space-x-5 relative z-10">
                        <div className="relative group cursor-pointer">
                            {(customer.photoUrl && customer.photoUrl !== "NA") ? (
                                <img src={customer.photoUrl} alt="Avatar" className="w-20 h-20 rounded-full object-cover border-4 shadow-lg border-white bg-white transition-transform duration-300 group-hover:scale-105" />
                            ) : (
                                <div className="w-20 h-20 rounded-full bg-primary-100 border-4 shadow-lg flex items-center justify-center text-primary-700 text-3xl font-bold uppercase transition-transform duration-300 group-hover:scale-105 border-white">
                                    {formData.name && formData.name !== "NA" ? formData.name.charAt(0) : '?'}
                                </div>
                            )}
                        </div>
                        <div className="text-white">
                            <h2 className="text-2xl font-bold tracking-tight capitalize">{formData.name !== "NA" ? formData.name : 'Unknown Customer'}</h2>
                            <p className="text-primary-100/90 font-medium text-sm mt-0.5 font-mono">ID: {customer.uid}</p>
                            <div className="mt-2 flex items-center space-x-2">
                                <span className={`inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold backdrop-blur-sm shadow-sm transition-all duration-300 hover:shadow-md bg-emerald-400/20 text-emerald-50 border border-emerald-400/30`}>
                                    <Wallet className="w-3 h-3 mr-1" /> ₹{formData.wallet !== "NA" ? Number(formData.wallet).toFixed(2) : '0.00'}
                                </span>
                            </div>
                        </div>
                    </div>
                ...
                {/* Main Content Area */}
                <div className="flex-1 min-h-0 flex flex-col -mt-8 mx-6 bg-white rounded-t-2xl shadow-sm border border-slate-200 overflow-hidden z-10 pb-20">

                    <div className="flex border-b border-slate-200 bg-white/80 backdrop-blur-md sticky top-0 z-20 px-2 pt-2">
                        <div className="flex-1 py-3 px-4 text-sm font-semibold text-center border-b-2 transition-all duration-300 border-primary-600 text-primary-700 bg-primary-50/50 cursor-default">
                            <User className="w-4 h-4 inline-block mr-2 mb-0.5 text-primary-600" />
                            Customer Information
                        </div>
                    </div>

                    <div className="flex-1 overflow-y-auto px-6 py-6 border-b border-slate-200">
                        <form id="customer-edit-form" onSubmit={handleSubmit} className="space-y-8">
                            ...
                            <div className="group/section">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                    <div className="col-span-1 md:col-span-2 group/input">
                                        ...
                                        <input type="text" name="name" value={formData.name !== "NA" ? formData.name : ''} onChange={handleChange} className="w-full px-4 py-2.5 text-sm bg-slate-50/50 border border-slate-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 transition-all duration-200 hover:border-slate-300 shadow-sm outline-none" required placeholder="Full Name" />
                                    </div>
                                    <div className="group/input">
                                        ...
                                        <input type="tel" name="phone" value={formData.phone !== "NA" ? formData.phone : ''} onChange={handleChange} className="w-full px-4 py-2.5 text-sm bg-slate-50/50 border border-slate-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 transition-all duration-200 hover:border-slate-300 shadow-sm outline-none" placeholder="Phone Number" />
                                    </div>
                                    <div className="group/input">
                                        ...
                                        <input type="email" name="email" value={formData.email !== "NA" ? formData.email : ''} onChange={handleChange} className="w-full px-4 py-2.5 text-sm bg-slate-50/50 border border-slate-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 transition-all duration-200 hover:border-slate-300 shadow-sm outline-none" placeholder="Email Address" />
                                    </div>
                                    <div className="group/input">
                                        ...
                                        <input type="text" value={formData.dob !== "NA" ? formData.dob : ''} className="w-full px-4 py-2.5 text-sm bg-slate-100 border border-slate-200 text-slate-400 rounded-xl shadow-sm cursor-not-allowed outline-none" disabled placeholder="Not Configured" title="Date of Birth cannot be edited" />
                                    </div>
                                    <div className="group/input">
                                        ...
                                        <input type="text" value={formData.gender !== "NA" ? formData.gender : ''} className="w-full px-4 py-2.5 text-sm bg-slate-100 border border-slate-200 text-slate-400 rounded-xl shadow-sm cursor-not-allowed outline-none" disabled placeholder="Not Configured" title="Gender cannot be edited" />
                                    </div>
                                </div>
                            </div>
                            ...
                            {/* Address details */}
                            <div className="group/section">
                                <h3 className="text-sm font-bold text-slate-800 uppercase tracking-wider mb-4 flex items-center"><MapPin className="w-4 h-4 mr-2 text-primary-500 transition-transform group-hover/section:scale-110 duration-300" /> Location Profile</h3>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                    <div className="col-span-1 md:col-span-2 group/input">
                                        ...
                                        <textarea name="address" value={formData.address !== "NA" ? formData.address : ''} onChange={handleChange} rows="2" className="w-full px-4 py-2.5 text-sm bg-slate-50/50 border border-slate-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 transition-all duration-200 hover:border-slate-300 shadow-sm outline-none resize-none" placeholder="Primary Address"></textarea>
                                    </div>
                                    <div className="group/input">
                                        ...
                                        <input type="text" name="state" value={formData.state !== "NA" ? formData.state : ''} onChange={handleChange} className="w-full px-4 py-2.5 text-sm bg-slate-50/50 border border-slate-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 transition-all duration-200 hover:border-slate-300 shadow-sm outline-none" placeholder="State" />
                                    </div>
                                    <div className="group/input">
                            ...
                            {/* Guardian Settings */}
                            <div className="group/section">
                                <h3 className="text-sm font-bold text-amber-600 uppercase tracking-wider mb-4 flex items-center"><Phone className="w-4 h-4 mr-2" /> Guardian / Emergency Contact</h3>
                            ...
                            <div className="bg-slate-50 p-5 rounded-xl border border-slate-200">
                                <h3 className="text-sm font-bold text-slate-800 uppercase tracking-wider mb-4 flex items-center"><Calendar className="w-4 h-4 mr-2 text-primary-500" /> Application Data</h3>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 relative">
                                    <div className="group/card">
                                        <label className="block text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">Registered Date</label>
                            ...
                            <div className="bg-gradient-to-br from-slate-50 to-slate-100 rounded-xl p-5 border border-slate-200">
                                <h3 className="text-sm font-bold text-slate-800 uppercase tracking-wider mb-4 flex items-center"><Wallet className="w-4 h-4 mr-2 text-primary-500" /> Financial Settings</h3>
                                <div className="bg-white p-4 rounded-xl shadow-[0_2px_10px_-3px_rgba(0,0,0,0.05)] border border-slate-100 transition-all duration-300 group/card">
                                    ...
                                    <div className="relative md:w-1/2">
                                        ...
                                        <input type="number" step="0.01" name="wallet" value={formData.wallet !== "NA" ? formData.wallet : ''} onChange={handleChange} className="w-full pl-8 pr-4 py-2.5 text-lg font-bold text-slate-800 bg-slate-50/50 border border-slate-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 transition-all duration-200 hover:border-slate-300 shadow-sm focus:shadow-md outline-none" placeholder="0.00" />
                                    </div>
                                </div>
                            </div>
