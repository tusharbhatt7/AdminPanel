            ...
            <div className={`relative w-full sm:max-w-xl md:max-w-2xl bg-raised shadow-2xl flex flex-col h-full transform transition-transform duration-300 ease-out ${isVisible ? 'translate-x-0' : 'translate-x-full'}`}>
                ...
                <div className="flex-1 min-h-0 flex flex-col -mt-4 sm:-mt-8 mx-4 sm:mx-6 bg-surface rounded-t-2xl border border-line overflow-hidden z-10 pb-20">
                    ...
                    <div className="flex border-b border-line bg-surface/80 backdrop-blur-md sticky top-0 z-20 px-1 sm:px-2 pt-1 sm:pt-2">
                        <div className="flex-1 py-2 sm:py-3 px-2 sm:px-4 text-xs sm:text-sm font-semibold text-center border-b-2 transition-all duration-300 border-primary-600 text-brand-ink bg-primary-50/50 cursor-default">
                            <User className="w-3.5 h-3.5 sm:w-4 sm:h-4 inline-block mr-1.5 sm:mr-2 mb-0.5 text-brand-ink" />
                        ...
                        <form id="customer-edit-form" onSubmit={handleSubmit} className="space-y-6 sm:space-y-8">
                            ...
                            <div className="group/section">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5">
                                    ...
                                    <div className="group/input">
                                        <label className="block text-xs font-semibold text-fg-3 mb-1.5 flex items-center transition-colors group-focus-within/input:text-brand-ink"><Hash className="w-3 h-3 mr-1" /> Date of Birth</label>
                            ...
                            {/* Address details */}
                            <div className="group/section">
                                <h3 className="text-sm font-bold text-fg uppercase tracking-wider mb-3 sm:mb-4 flex items-center"><MapPin className="w-4 h-4 mr-2 text-brand-ink transition-transform group-hover/section:scale-110 duration-300" /> Location Profile</h3>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5">
                                    <div className="col-span-1 md:col-span-2 group/input">
                                        <label className="block text-xs font-semibold text-fg-3 mb-1.5 transition-colors group-focus-within/input:text-brand-ink">Full Address</label>
                                    ...
                                    <div className="group/input">
                                        <label className="block text-xs font-semibold text-fg-3 mb-1.5 transition-colors group-focus-within/input:text-brand-ink">State / Region</label>
                                    ...
                                    <div className="group/input">
                                        <label className="block text-xs font-semibold text-fg-3 mb-1.5 transition-colors group-focus-within/input:text-brand-ink">Pincode</label>
                            ...
                            <div className="bg-raised p-4 sm:p-5 rounded-lg border border-line">
                                <h3 className="text-sm font-bold text-fg uppercase tracking-wider mb-3 sm:mb-4 flex items-center"><Calendar className="w-4 h-4 mr-2 text-brand-ink" /> Application Data</h3>
                            ...
                            <div className="bg-raised rounded-lg p-4 sm:p-5 border border-line">
                                <h3 className="text-sm font-bold text-fg uppercase tracking-wider mb-3 sm:mb-4 flex items-center"><Wallet className="w-4 h-4 mr-2 text-brand-ink" /> Financial Settings</h3>
                                <div className="bg-surface p-4 rounded-lg shadow-[0_2px_10px_-3px_rgba(0,0,0,0.05)] border border-line/60 transition-all duration-300 group/card">
                                    <label className="block text-xs font-semibold text-fg-3 uppercase tracking-wider mb-2 transition-colors group-focus-within/card:text-brand-ink">Wallet Balance</label>
